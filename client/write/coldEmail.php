...
<body>
    ...
    <div class="container mt-5" style="max-width: 1200px;">
        <div class="text-center mb-4">
            <h1 class="fw-bolder ">AI Cold Email Generator</h1>
            <h5 class="fw-normal mt-3">Let AI Generate an Email Generator</h5>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="card col-12 col-md-4">
                ...
                <input type="hidden" name="promptType" id="promptType" value="coldEmail">
