<nav class="navbar navbar-expand-lg bg-body-tertiary shadow-sm sticky-top">
    <div class="container px-2 px-lg-3">
        <a class="navbar-brand" href="?home=true">ToolHub</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav gap-4 me-auto ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="?image=true">
                        Image
                    </a>
                    <ul class="dropdown-menu">
                        <div class="d-lg-flex pdf-dropdown">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="?write=true">
                        Write
                    </a>
                    <ul class="dropdown-menu">
                        <div class="d-lg-flex pdf-dropdown">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="?video=true">
                        Video
                    </a>
                    <ul class="dropdown-menu">
                        <div class="d-lg-flex pdf-dropdown">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="?file=true">
                        File
                    </a>
                    <ul class="dropdown-menu">
                        <div class="d-lg-flex pdf-dropdown">
